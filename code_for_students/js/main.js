...
var modal_page = document.querySelector(".page__modal");

document.querySelector(".banner__button").onclick = function(ev) {
  modal_page.classList.add("modal--open");
}
document.querySelector(".modal__close").onclick = function(ev) {
  modal_page.classList.remove("modal--open");
}
